...
public:
	...
	Nodo left(Nodo) const;
	Nodo right(Nodo) const;
	bool EmptyLeft(Nodo) const;
	bool EmptyRight(Nodo) const;
...
template <class T>
typename     Bin_treec<T>::Nodo Bin_treec<T>::left(Nodo n) const
{
	if (!EmptyLeft(n))
...
template <class T>
typename     Bin_treec<T>::Nodo Bin_treec<T>::right(Nodo n) const
{
	if (!EmptyRight(n))
...
template <class T>
bool Bin_treec<T>::EmptyLeft(typename Bin_treec<T>::Nodo n) const
{
	return (spazio[n].sinistro == NIL);
}

template <class T>
bool Bin_treec<T>::EmptyRight(typename Bin_treec<T>::Nodo n) const
{
...
template <class T>
void Bin_treec<T>::AddLeft(Nodo n)
{
	if (inizio == NIL)
		throw EmptyTree();
	if (n == NIL)
...
template <class T>
void Bin_treec<T>::AddRight(Nodo n)
{
	if (inizio == NIL)
		throw EmptyTree();
	if (n == NIL)
