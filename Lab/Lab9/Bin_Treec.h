...
template <class T>
bool Bin_treec<T>::sx_empty(typename Bin_treec<T>::Nodo n) const
{
	return (spazio[n].sinistro == NIL);
}

template <class T>
bool Bin_treec<T>::dx_empty(typename Bin_treec<T>::Nodo n) const
{
	return (spazio[n].destro == NIL);
}

template <class T>
void Bin_treec<T>::ins_root(typename Bin_treec<T>::Nodo n)
{
	if (inizio == NIL)
	{
		inizio = libera;
